#calcular média semestral do aluno (Int)

.text 

main:
	#1 - ler um numero e armazena-lo
	addi $v0, $zero, 5 #ordem de serviço: ler entrada
	syscall	
mult2:
...
armazenar:
	...
	addi $v0, $zero, 5 #ordem de serviço 
	syscall	
...
div: 
	...
	mflo $a0 #armazenando resuldado em LO (inteiro) da divisão na var de visualização
	
	
	addi $v0, $zero, 1 #ordem de serviço: imprimir 
	syscall
over:
	addi $v0, $zero, 10
	syscall
